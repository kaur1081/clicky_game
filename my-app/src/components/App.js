...
class App extends Component {
    ...
    shuffleArray() {
      // creates a copy of the current Avengers array to modify it by value, and not by reference
    ...
    // passes the randomized state.allAvengers array to Container to create a Character component for each image.
